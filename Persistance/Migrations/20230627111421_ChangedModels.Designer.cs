...
namespace Persistance.Migrations
{
    ...
    [Migration("20230627111421_ChangedModels")]
            ...
            modelBuilder.Entity("Domain.Festival", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d17df312-8412-4aa0-a014-b7488a3a2ffc"),
                            City = "Beograd",
                            EndDate = new DateTime(2023, 8, 27, 11, 14, 21, 684, DateTimeKind.Utc).AddTicks(674),
                            Name = "Festival 1",
                            StartDate = new DateTime(2023, 7, 27, 11, 14, 21, 684, DateTimeKind.Utc).AddTicks(669),
                            ZipCode = 36300
                        },
                        new
                        {
                            Id = new Guid("2cbf70ff-f822-4d06-a716-7986a5e40f51"),
                            City = "Beograd",
                            EndDate = new DateTime(2023, 10, 27, 11, 14, 21, 684, DateTimeKind.Utc).AddTicks(683),
                            Name = "Festival 2",
                            StartDate = new DateTime(2023, 9, 27, 11, 14, 21, 684, DateTimeKind.Utc).AddTicks(682),
                            ZipCode = 36300
                        },
                        new
                        {
                            Id = new Guid("e16ba146-d58c-499f-a433-14fdf975e904"),
                            City = "Beograd",
                            EndDate = new DateTime(2023, 12, 27, 11, 14, 21, 684, DateTimeKind.Utc).AddTicks(689),
                            Name = "Festival 3",
                            StartDate = new DateTime(2023, 11, 27, 11, 14, 21, 684, DateTimeKind.Utc).AddTicks(689),
                            ZipCode = 36300
                        },
                        new
                        {
                            Id = new Guid("4dde64ba-5a06-4879-80f6-21ddf31f13b9"),
                            City = "Beograd",
                            EndDate = new DateTime(2024, 2, 27, 11, 14, 21, 684, DateTimeKind.Utc).AddTicks(696),
                            Name = "Festival 4",
                            StartDate = new DateTime(2024, 1, 27, 11, 14, 21, 684, DateTimeKind.Utc).AddTicks(695),
                            ZipCode = 36300
                        },
                        new
                        {
                            Id = new Guid("d3bfe2a9-95d8-4525-8bda-562549c45c20"),
                            City = "Beograd",
                            EndDate = new DateTime(2024, 4, 27, 11, 14, 21, 684, DateTimeKind.Utc).AddTicks(702),
                            Name = "Festival 5",
                            StartDate = new DateTime(2024, 3, 27, 11, 14, 21, 684, DateTimeKind.Utc).AddTicks(701),
                            ZipCode = 36300
                        });
                });
