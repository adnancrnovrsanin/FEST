...
namespace Persistance.Migrations
{
    ...
    [Migration("20230616131431_AddedFestivalScheduleRelation")]
    partial class AddedFestivalScheduleRelation
    {
            ...
            modelBuilder.Entity("Domain.Festival", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cdb7e9cc-d024-47c5-b85f-66d3c11659d4"),
                            City = "Beograd",
                            EndDate = new DateTime(2023, 8, 16, 13, 14, 30, 850, DateTimeKind.Utc).AddTicks(6724),
                            Name = "Festival 1",
                            StartDate = new DateTime(2023, 7, 16, 13, 14, 30, 850, DateTimeKind.Utc).AddTicks(6716),
                            ZipCode = 36300
                        },
                        new
                        {
                            Id = new Guid("469b5fe7-ed22-45b9-b624-5b82fa235da4"),
                            City = "Beograd",
                            EndDate = new DateTime(2023, 10, 16, 13, 14, 30, 850, DateTimeKind.Utc).AddTicks(6734),
                            Name = "Festival 2",
                            StartDate = new DateTime(2023, 9, 16, 13, 14, 30, 850, DateTimeKind.Utc).AddTicks(6733),
                            ZipCode = 36300
                        },
                        new
                        {
                            Id = new Guid("7b4d7315-c513-425f-8232-58f77c1bbce2"),
                            City = "Beograd",
                            EndDate = new DateTime(2023, 12, 16, 13, 14, 30, 850, DateTimeKind.Utc).AddTicks(6740),
                            Name = "Festival 3",
                            StartDate = new DateTime(2023, 11, 16, 13, 14, 30, 850, DateTimeKind.Utc).AddTicks(6740),
                            ZipCode = 36300
                        },
                        new
                        {
                            Id = new Guid("4043b607-2cba-4f22-971d-e1a314bac332"),
                            City = "Beograd",
                            EndDate = new DateTime(2024, 2, 16, 13, 14, 30, 850, DateTimeKind.Utc).AddTicks(6747),
                            Name = "Festival 4",
                            StartDate = new DateTime(2024, 1, 16, 13, 14, 30, 850, DateTimeKind.Utc).AddTicks(6746),
                            ZipCode = 36300
                        },
                        new
                        {
                            Id = new Guid("11adb3d4-18d8-42a1-8b18-1b835f559c2d"),
                            City = "Beograd",
                            EndDate = new DateTime(2024, 4, 16, 13, 14, 30, 850, DateTimeKind.Utc).AddTicks(6753),
                            Name = "Festival 5",
                            StartDate = new DateTime(2024, 3, 16, 13, 14, 30, 850, DateTimeKind.Utc).AddTicks(6753),
                            ZipCode = 36300
                        });
                });
